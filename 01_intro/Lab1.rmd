...
arbuthnot <- arbuthnot %>% mutate(boys_proportion = boys/total)
ggplot(data=arbuthnot, aes(x=year, y=boys_proportion)) + geom_point() + geom_line()
```
...
#  mutate(total = ?) %>%
#  arrange(desc(total))
last(arrange(present,total, desc(total))[4])
